...
// (in-package smartcar_control.srv)
...
class SetPointResponse {
  ...
  static datatype() {
    // Returns string type for a service object
    return 'smartcar_control/SetPointResponse';
  }
...
module.exports = {
  ...
  md5sum() { return '3374a123f3f3fd3591258738a2b4096b'; },
  datatype() { return 'smartcar_control/SetPoint'; }
};
